    ...
    <section id="info">
        <v-container>            
            ...
            <v-row>
                <v-col 
                    lg="6"
                    class="cont_elementos text-center"
                >
                
                    <p class="textos">Studio tántrico está amenizado para tu plena seguridad y comodidad.</p>
                    <v-row>
                        <v-col 
                            cols="12" 
                            sm="6" 
...
<script>
    ...
    export default{
        ...
        data(){
            return{
                slides: [require('../assets/carrusel/01.jpg'),
